...
class Ui_curso_has_disciplina(object):
    def setupUi(self, curso_has_disciplina):
        ...
        self.tableCurso_has_Disciplina.setColumnCount(4)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tableCurso_has_Disciplina.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableCurso_has_Disciplina.setHorizontalHeaderItem(3, item)
    ...
    def retranslateUi(self, curso_has_disciplina):
        ...
        item.setText(_translate("curso_has_disciplina", "idCurso"))
        item = self.tableCurso_has_Disciplina.horizontalHeaderItem(1)
        item.setText(_translate("curso_has_disciplina", "nomeCurso"))
        item = self.tableCurso_has_Disciplina.horizontalHeaderItem(2)
        item.setText(_translate("curso_has_disciplina", "idDisciplina"))
        item = self.tableCurso_has_Disciplina.horizontalHeaderItem(3)
