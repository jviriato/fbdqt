...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.labelDiariodeClasse, 0, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.btnInserir, 2, 1, 2, 1)
        ...
        self.gridLayout.addLayout(self.siglaCurso, 3, 0, 1, 1)
        ...
        self.linenomeCurso.raise_()
        self.lineSiglaCurso.raise_()
        self.labelNomeCurso.raise_()
        self.labelsiglaCurso.raise_()
        self.labelNomeCurso.raise_()
